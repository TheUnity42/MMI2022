...
<SensorDrawer>
	<div class="p-3 pl-4 overflow-x-clip">
		<h1 class="text-3xl font-semibold">Man Muscle Sensor Dashboard</h1>
		<label 
			for="help-modality"
			class="absolute top-3 right-3 btn btn-info btn-square btn-sm rounded-md">
			?
		</label>
		<HelpModality />
